...
export declare type IFlexLayout = "row center center" | "row center start" | "row center end" | "row start start" | "row end end" | "row start center" | "row start end" | "row end center" | "row end start" | "row between start" | "row between center" | "row between end" | "row around start" | "row around center" | "row around end" | "col center center" | "col center start" | "col center end" | "col start start" | "col end end" | "col start center" | "col start end" | "col end center" | "col end start" | "col between start" | "col between center" | "col between end" | "col around start" | "col around center" | "col around end";
